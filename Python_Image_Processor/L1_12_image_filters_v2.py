from Cimpl import choose_file, load_image, copy, create_color, create_image, set_color,\
                  show, Image, get_color, get_width, get_height, save_as
...
def extreme_contrast(image: Image) -> Image:
    """
    Author: Tahir Towsif
    Function takes in an image and will turn rgb values greater than or equal 127 into a value of 255, and will take rgb values lower than 127 and they will become 0. These new rgb values will be usesd to produce a new image with extreme contrast on either end of the spectrum.
